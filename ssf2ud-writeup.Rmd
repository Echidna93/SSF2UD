...
thinVals <- c(1, seq(25, 250, by = 25))
```


```{r generate betaSSF v nThin Plots, echo = FALSE, eval = FALSE}
# SIMULATION ---------------`----------------------------------------------------
...
for(i in 1:10000){
  ...
  landscape <- makeLandscapeMatrix(nrow, ncol)
