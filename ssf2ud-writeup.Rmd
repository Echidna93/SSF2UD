...
## Introduction
Landscape heterogeneity (i.e., the variation in land cover types and their arrangement therein) is fundamentally intertwined with ecological processes (@wiensCentralConceptsIssues2002). It's influence spans ecological scales from the individual (@vanmoorterUnderstandingScalesMovement2013) to the population (@muellerSearchNavigationDynamic2008) and this variation can influential in both space as well as time @aikensGreenscapeShapesSurfing2017a.

Movement is primarily a behavioral adaption to landscape heterogeneity @mcpeekEvolutionDispersalSpatially1992. Heterogeneity influences movement from a variety of lenses including @mcpeekEvolutionDispersalSpatially1992. Individuals change the scale of their movement based on the scale of landscape heterogeneity (@vanmoorterUnderstandingScalesMovement2013). The accumulation of an individuals movement decisions creates patterns of space use (space use patterns; SUPs) which are at their core responses landscape heterogeneity (@vanmoorterMovementGlueConnecting2016, @muellerSearchNavigationDynamic2008).

Broadly landscape heterogeneity can (for our purposes) be divided into compositional and structural heterogeneity @fahrigFunctionalLandscapeHeterogeneity2011.

The diversity of animal movement and the lenses through which to view it has lead to the development of a variety of methodologies to classify and describe it in relation to observed landscape heterogeneity. Broadly, these methodologies are described as species habitat associations (SHAs; @matthiopoulosSpeciesHabitatAssociationsSpatial2020b). This can broadly be viewed as the area in which an animal restricts it's movement within possible areas where it could range. These methodologies can broadly be divided along phenomonological and mechanistic lines 

The utilization distribution (UD) describes the probability that a given individual will be detected in a given location @winkleComparisonSeveralProbabilistic1975 and given that Ecology is fundamentally the study of the factors which drive the arrangement of organisms over space and time @eltonAnimalEcology1927 this quantity is of paramount importance. The UD has been utilized to help address conservation issues ranging from wildlife disease @jennelleMovementWhitetailedDeer2022a to energy development @cervantesUtilizationDistributionGlobal2023. 
...
Underlying the apparent distributions of organisms are of course the movements of individuals. These movements are influenced by the scale landscape heterogeneity (@vanmoorterUnderstandingScalesMovement2013). Importantly the build-up of these individual movement decisions which are influenced by landscape heterogeneity in turn influence the space-use patterns of individuals (@vanmoorterMovementGlueConnecting2016b).
